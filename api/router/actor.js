...
router.post('/UpdateActor/:id',TokenController.is_admin,ActorController.UpdateActor);
router.post('/DeleteActor/:id',TokenController.is_admin,ActorController.DeleteActor);
